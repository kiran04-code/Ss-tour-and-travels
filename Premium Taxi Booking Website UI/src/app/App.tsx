...
function Logo() { return <a href="#home" className="flex h-10 sm:h-12 lg:h-16 items-center shrink-0" aria-label="SS Tours and Travels home"><img src={logo} alt="SS Tours & Travels" className="h-full w-auto max-w-[170px] sm:max-w-[220px] lg:max-w-[280px] object-contain object-left" /></a> }
  ...
  <div className="mx-auto max-w-[1320px]">
    ...
    <div className="mt-10 border-t border-white/10 pt-5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/40">
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <a href="/admin" className="inline-flex items-center gap-1 font-semibold text-white/60 hover:text-[#F9B900] transition">
          <ShieldCheck size={13} className="text-[#F9B900]" /> Admin Portal
        </a>
      </div>
    </div>
  </div>
